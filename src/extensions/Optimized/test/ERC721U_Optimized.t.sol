...
import {MockERC721Optimized} from "./Mocks/MockERC721_optimized.sol";

import {ERC721TokenReceiver} from "../ERC721U_Optimized.sol";
...
contract ERC721UTestOptimized is DSTestPlus {
    MockERC721Optimized token;

    function setUp() public {
        token = new MockERC721Optimized("Token", "TKN");
    }
    ...
    function testMetadata(string memory name, string memory symbol) public {
        MockERC721Optimized tkn = new MockERC721Optimized(name, symbol);
